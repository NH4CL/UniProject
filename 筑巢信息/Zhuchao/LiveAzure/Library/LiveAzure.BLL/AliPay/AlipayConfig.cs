...
namespace Com.Alipay
{
    ...
    internal class Config
    {
        ...
        static Config()
        {
            ...
            partner = "2088501578690254";

            //交易安全检验码，由数字和字母组成的32位字符串
            key = "15p9xjrmy378ytelyhdtnre2efvcfsm0";

            //签约支付宝账号或卖家支付宝帐户
            seller_email = "payment@zhuchao.com";

            //页面跳转同步返回页面文件路径 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            return_url = "http://127.0.0.1:1954/Alipay/return_url";

            //服务器通知的页面文件路径 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            notify_url = "http://www.xxx.com/create_partner_trade_by_buyer_vs2005_utf8/notify_url.aspx";
